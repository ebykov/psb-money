...
exports.default = {
  ...
  text: '<p>Предприниматели далеко не всегда тратят деньги обдуманно — став состоятельным, можно пуститься во все тяжкие и совершать абсурдные покупки.</p><p>Вместе с «Промсвязьбанком» мы вспомнили истории, когда предприниматели нелепо тратили деньги, а ещё несколько придумали. Вам нужно разобраться, какие истории реальны, а какие — выдумка.</p>',
